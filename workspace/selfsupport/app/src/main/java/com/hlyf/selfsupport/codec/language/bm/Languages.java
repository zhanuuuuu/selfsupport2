...
import com.hlyf.selfsupport.codec.language.bm.ResourceConstants;
 ...
 * pattern:
 * </p>
 * <blockquote>org/apache/commons/codec/language/bm/${{@link com.hlyf.selfsupport.codec.language.bm.NameType#getName()} languages.txt</blockquote>
 * <p>
...
public class Languages {
    ...
    private static final Map<com.hlyf.selfsupport.codec.language.bm.NameType, Languages> LANGUAGES = new EnumMap<com.hlyf.selfsupport.codec.language.bm.NameType, Languages>(com.hlyf.selfsupport.codec.language.bm.NameType.class);

    static {
        for (com.hlyf.selfsupport.codec.language.bm.NameType s : com.hlyf.selfsupport.codec.language.bm.NameType.values()) {
            LANGUAGES.put(s, getInstance(langResourceName(s)));
        }
    }

    public static Languages getInstance(com.hlyf.selfsupport.codec.language.bm.NameType nameType) {
