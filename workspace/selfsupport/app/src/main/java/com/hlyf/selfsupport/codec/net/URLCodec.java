...
package com.hlyf.selfsupport.codec.net;

import java.io.ByteArrayOutputStream;
import java.io.UnsupportedEncodingException;
import java.util.BitSet;

import com.hlyf.selfsupport.codec.BinaryDecoder;
import com.hlyf.selfsupport.codec.BinaryEncoder;
import com.hlyf.selfsupport.codec.CharEncoding;
import com.hlyf.selfsupport.codec.DecoderException;
import com.hlyf.selfsupport.codec.EncoderException;
import com.hlyf.selfsupport.codec.StringDecoder;
import com.hlyf.selfsupport.codec.StringEncoder;
import com.hlyf.selfsupport.codec.binary.StringUtils;
import com.hlyf.selfsupport.codec.net.Utils;
    ...
    public static final byte[] decodeUrl(byte[] bytes) throws DecoderException {
        ...
        for (int i = 0; i < bytes.length; i++) {
            ...
            if (b == '+') {
                ...
                try {
                    int u = com.hlyf.selfsupport.codec.net.Utils.digit16(bytes[++i]);
                    int l = com.hlyf.selfsupport.codec.net.Utils.digit16(bytes[++i]);
