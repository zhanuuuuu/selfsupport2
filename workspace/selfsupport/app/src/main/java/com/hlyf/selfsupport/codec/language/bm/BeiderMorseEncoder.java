...
import com.hlyf.selfsupport.codec.EncoderException;
import com.hlyf.selfsupport.codec.StringEncoder;
import com.hlyf.selfsupport.codec.language.bm.NameType;
import com.hlyf.selfsupport.codec.language.bm.PhoneticEngine;
 ...
 * thread-safe. If you require a guaranteed thread-safe encoding then use {@link com.hlyf.selfsupport.codec.language.bm.PhoneticEngine} directly.
 * </p>
 *
...
public class BeiderMorseEncoder implements StringEncoder {
    ...
    // a cached object
    private com.hlyf.selfsupport.codec.language.bm.PhoneticEngine engine = new com.hlyf.selfsupport.codec.language.bm.PhoneticEngine(com.hlyf.selfsupport.codec.language.bm.NameType.GENERIC, com.hlyf.selfsupport.codec.language.bm.RuleType.APPROX, true);
     ...
     */
    public com.hlyf.selfsupport.codec.language.bm.NameType getNameType() {
     ...
     */
    public com.hlyf.selfsupport.codec.language.bm.RuleType getRuleType() {
    ...
    public void setConcat(boolean concat) {
        this.engine = new com.hlyf.selfsupport.codec.language.bm.PhoneticEngine(this.engine.getNameType(), this.engine.getRuleType(), concat);
    }

    /**
     * Sets the type of name. Use {@link com.hlyf.selfsupport.codec.language.bm.NameType#GENERIC} unless you specifically want phoentic encodings optimized for Ashkenazi or
    ...
    public void setNameType(NameType nameType) {
        this.engine = new com.hlyf.selfsupport.codec.language.bm.PhoneticEngine(nameType, this.engine.getRuleType(), this.engine.isConcat());
    }
     ...
     * 
     * @param ruleType
     *            {@link com.hlyf.selfsupport.codec.language.bm.RuleType#APPROX} or {@link com.hlyf.selfsupport.codec.language.bm.RuleType#EXACT} for approximate or exact phonetic matches
     */
